...
function SaveContractor() {
    var model = {};
    model.ID = $('#ID').val();
    model.ContractorName = $('#ContractorName').val();
    model.BillAddress = $('#BillAddress').val();
    model.BillCity = $('#BillCity').val();
    model.BillState = $('#BillStateId').val();
    model.BillZip = $('#BillZip').val();
    ...
    setTimeout(function () {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: '/StaffAccount/UpdateContractorProfile/',
            data: { 'model': model },
            async: false,
